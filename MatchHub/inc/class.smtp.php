...
class SMTP {
  ...
  public function Data($msg_data) {
    ...
    foreach ($lines as $line) {
      ...
      // Bu satırı daha küçük satırlara bölmemiz gerekiyor
      while (strlen($line) > $max_line_length) {
          ...
          /* Eğer başlıkları işliyorsak, yeni satırın başına bir LWSP karakteri ekle
           * RFC 822 uzun mesaj başlıklarında bunu tanımlar
           */
          if ($in_headers) {
              $line = "\t" . $line;
          }
