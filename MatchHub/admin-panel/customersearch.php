<?php require_once 'inc/header.php';?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Kullanıcı Arama Sonuçları</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo admin;?>"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item active"><a href="#">Kullanıcı Arama Sonuçları</a></li>
        </ul>
      </div>
      <div class="row">
      ...
      <form action="<?php echo admin."/customersearch.php";?>" method="GET" class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div class="tile">
            <h3 class="tile-title">Kullanıcı Arama Sonuçları (<?php echo $total;?>)</h3>
