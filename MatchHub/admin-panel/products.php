<?php require_once 'inc/header.php';?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Oyun Listesi</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo admin;?>"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item active"><a href="#">Oyun Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <form action="<?php echo admin."/productsearch.php";?>" method="GET" class="col-md-12">
          <div class="form-group">
            <input type="text" name="q" class="form-control" placeholder="Oyun adı giriniz" />
          </div>
        </form>
        ...
        <div class="col-md-12">
          ...
          <div class="tile">
            <h3 class="tile-title">Oyun Listesi (<?php echo $total;?>)</h3>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <?php foreach($query as $row){ ?>
                    ...
                    <td><img src="<?php echo $site."/uploads/forums/".$row['urunkapak'];?>" width="100" height="100"/></td>
