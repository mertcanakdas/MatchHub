...
<div class="row">
	...
	<form action="" method="POST" onsubmit="return false;" id="passwordform2">	
		<div class="customer-login text-left">
			...
			<input type="text" placeholder="e-posta adresi" name="bec">
			<!-- <input type="text" placeholder="Kullanıcı kodu" name="bcode"> -->

			<button type="submit" onclick="passwordbutton2();" id="passwordbuton2" class="button-one submit-button mt-15">ŞİFREMİ SIFIRLA</button>
		</div>		
		</form>			
	</div>
